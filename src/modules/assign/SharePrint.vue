  ...
  <div>
    ...
    <div v-else class="content">
      <header class="header">
        <div class="flex">
          <h1>
            <router-link :to="backTo" title="Go back home" class="link-back">
          ...
          <button class="pull-right button button-primary" @click="print">
...
export default {
  ...
  methods: {
    ...
    print() {
      analytics('Assess Activity Printed', { assessmentId: this.assessment.id });
      window.print();
    },
    replaceBlanks(text) {
